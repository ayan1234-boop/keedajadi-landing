    ...
    <div className="bg-white text-gray-800 font-sans relative">
      ...
      >
        ...
        <div className="relative z-10 ">
          <h1 className="inline-block bg-black bg-opacity-90 text-4xl md:text-6xl font-bold mb-4 text-green-500 px-6 py-4 rounded-lg drop-shadow-[0_2px_4px_rgba(0,0,0,0.8)] transform -translate-x-6">कीड़ा जड़ी – हिमालय की ऊँचाइयों से</h1>
